...
export function Avaliacoes() {
  ...
  const SETORES_OP = ['Cozinha', 'Cozinha - Checklist Semanal', 'Bar', 'Bar - Dia de Evento', 'Bar - Pré Preparo', 'Bar - Checklist Semanal', 'Atendimento - Maitres', 'Atendimento - Maitres Checklist', 'Atendimento - Pré evento']
