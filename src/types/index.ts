...
export interface Database {
  public: {
    Tables: {
      ...
      usuarios: {
        Row: { id: string; nome: string; role: 'rede' | 'lider' | 'leitura'; setores_avaliacao: string[]; pode_nutri: boolean; status: 'pendente' | 'ativo' | 'recusado'; unidades_ids: string[] | null }
        Insert: { id: string; nome: string; role: 'rede' | 'lider' | 'leitura'; setores_avaliacao?: string[]; pode_nutri?: boolean; status?: 'pendente' | 'ativo' | 'recusado'; unidades_ids?: string[] | null }
        Update: { nome?: string; role?: 'rede' | 'lider' | 'leitura'; setores_avaliacao?: string[]; pode_nutri?: boolean; status?: 'pendente' | 'ativo' | 'recusado'; unidades_ids?: string[] | null }
      }
      usuario_unidade: {
